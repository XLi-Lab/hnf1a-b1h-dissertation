...
# the protein-DNA chain pair alone, quoted separately in Table D2 and used as the
# y-axis of Figure 6B; cpi[0,1] and cpi[0,2] are the two protein-DNA chain pairs
print(f"    protein-DNA ipTM       {np.mean([cpi[0,1],cpi[0,2]]):.2f}")
