...
Takes raw Nanopore amplicon FASTQs through to the tissue-annotated enrichment
table. Demultiplexing follows the original analysis, so the counts reproduce.

Analysis only. No figure is drawn here; the plotting code is not deposited.

No statistical test is applied anywhere in this script either. Tier assignment is
a fixed effect-size cut on the replicate-mean Delta log2FC (Methods 2.11), not a
hypothesis test, so no p value is computed or corrected here.
...
ODOM_S2_HEPATOCYTE = [
    ...
    ("DKFZP564O0463","NM_014156"),("DKFZP586A0522","NM_014033"),("DKFZP586M0122","NM_015425"),("DLEU1","NM_005887"),
    ("DUSP6","NM_022652"),("EIF4EBP2","NM_004096"),("ELF3","NM_004433"),("ENPEP","NM_001977"),
    ("F11","NM_019559"),("FE65L2","NM_006051"),("FH","NM_000143"),("FKSG87","NM_032029"),
    ("FLJ10242","NM_018036"),("FLJ10276","NM_018045"),("FLJ10525","NM_018126"),("FLJ10583","NM_018148"),
    ("FLJ10650","NM_018168"),("FLJ10774","NM_024662"),("FLJ11000","NM_018295"),("FLJ11838","NM_024664"),
    ("FLJ12788","NM_022492"),("FLJ13448","NM_025147"),("FLJ13611","NM_024941"),("FLJ14356","NM_030824"),
    ("FLJ20080","NM_017657"),("FLJ20718","NM_017939"),("FLJ21272","NM_025032"),("FLJ21934","NM_024743"),
    ("FLJ22551","NM_024708"),("FLJ23259","NM_024727"),("FNTB","NM_002028"),("G0S2","NM_015714"),
    ("G3A","NM_019101"),("G6PT1","NM_001467"),("GARS","NM_002047"),("GBE1","NM_000158"),
    ("GCKR","NM_001486"),("GDI2","NM_001494"),("GIOT-2","NM_016264"),("GJB1","NM_000166"),
    ("GOT1","NM_002079"),("GPR39","NM_001508"),("GPX2","NM_002083"),("GRHPR","NM_012203"),
    ("GTF2B","NM_001514"),("GTF2E1","NM_005513"),("GTPBG3","NM_032620"),("HABP2","NM_004132"),
    ("HAL","NM_002108"),("HAO1","NM_017545"),("HCAP-G","NM_022346"),("HGD","NM_000187"),
    ("HGFAC","NM_001528"),("HNF4A","NM_000457"),("HNF4a7","AF509467"),("HNMT","NM_006895"),
    ("HPCL2","NM_012260"),("HPX","NM_000613"),("HSD11B1","NM_005525"),("HSD17B2","NM_002153"),
    ("HSPC111","NM_016391"),("HSPC129","NM_016396"),("IFNAR1","NM_000629"),("IGF1R","NM_000875"),
    ("IGFBP1","NM_000596"),("INADL","NM_005799"),("ITIH3","NM_002217"),("ITIH4","NM_002218"),
    ("ITM2B","NM_021999"),("KIAA0022","NM_014880"),("KIAA0669","NM_014779"),("KIAA0844","NM_014951"),
    ("KIAA0872","NM_014940"),("KIAA1041","NM_014947"),("KNG","NM_000893"),("LBP","NM_004139"),
    ("LOC51060","NM_015913"),("LOC51096","NM_016001"),("LOC51326","NM_016632"),("LOC54518","NM_019043"),
    ("LOC56902","NM_020143"),("LOC58486","NM_021211"),("LY6E","NM_002346"),("M17S2","NM_031858"),
    ("M96","NM_007358"),("MAGEA9","NM_005365"),("MGC10500","NM_031477"),("MGC11034","NM_031453"),
    ("MGC11266","NM_024322"),("MGC13010","NM_032687"),("MGC15435","NM_032367"),("MGC955","NM_024097"),
    ("MIA2","NM_054024"),("MRPL15","NM_014175"),("MRPS18B","NM_014046"),("MSH6","NM_000179"),
    ("MT1H","NM_005951"),("MT1L","NM_002450"),("MT1X","NM_005952"),("MTHFD1","NM_005956"),
    ("MTP","NM_000253"),("NAPA","NM_003827"),("NET-2","NM_012338"),("NFKBIB","NM_002503"),
    ("NPC1L1","NM_013389"),("NR0B2","NM_021969"),("NR1D1","NM_021724"),("NR5A2","NM_003822"),
    ("NRD1","NM_002525"),("PAFAH2","NM_000437"),("PAX8","NM_013952"),("PCK1","NM_002591"),
    ("PHF2","NM_005392"),("PIST","NM_020399"),("PLCB1","NM_015192"),("PLG","NM_000301"),
    ("PLGL","NM_002665"),("PS-PLA1","NM_015900"),("PZP","NM_002864"),("RAB33B","NM_031296"),
    ("RAMP","NM_016448"),("RARB","NM_016152"),("RBP5","NM_031491"),("RNGTT","NM_003800"),
    ("RPL37AP1","NG_000988"),("SAC","NM_018417"),("SCYE1","NM_004757"),("SEL1L","NM_005065"),
    ("SERPINA1","NM_000295"),("SERPINA10","NM_016186"),("SERPINA6","NM_001756"),("SERPINC1","NM_000488"),
    ("SERPINE1","NM_000602"),("SERPING1","NM_000062"),("SGK2","NM_016276"),("SLC17A2","NM_005835"),
    ("SLC22A11","NM_018484"),("SLPI","NM_003064"),("SNX17","NM_014748"),("SRI","NM_003130"),
    ("SSA2","NM_004600"),("SSTR1","NM_001049"),("SSTR4","NM_001052"),("STRAIT11499","NM_021242"),
    ("SUPV3L1","NM_003171"),("SYN3","NM_133632"),("TARS","NM_003191"),("TBPL1","NM_004865"),
    ("TEF","NM_003216"),("TFRC","NM_003234"),("TIEG2","NM_003597"),("TM4SF4","NM_004617"),
    ("TMEM1","NM_003274"),("TNFRSF6","NM_000043"),("UGT1A1","NM_000463"),("UGT2B11","NM_001073"),
    ("UGT2B15","NM_001076"),("UQCRC2","NM_003366"),("VNN3","NM_018399"),("VTN","NM_000638"),
    ("WBP4","NM_007187"),("WDF2","NM_052950"),("WDR12","NM_018256"),("XDH","NM_000379"),
    ("XPC","NM_004628"),("ZK1","NM_005815"),("ZNF288","NM_015642"),("ZNF361","NM_018555"),
]
...
# ---------------------------------------------------------------------------
# STAGE 2b: uncertainty on delta-log2FC (Appendix D, Table D3)
# ---------------------------------------------------------------------------
# Poisson resampling of the read counts. Each of the eight count vectors is
# redrawn independently, every count from a Poisson distribution with mean
# equal to the observed count, and delta-log2FC recomputed within each draw
# under exactly the pipeline's own frequency and pseudocount convention.
#
# Reported per motif:
#   ci_low, ci_high   2.5th and 97.5th percentile of delta-log2FC across draws
#   tier_retained     proportion of draws in which the motif still satisfies
#                     the criteria for the tier assigned on the observed data,
#                     that is complete replicate separation together with the
#                     relevant delta-log2FC threshold
#
# Set N_DRAWS and SEED here. Results move by hundredths between seeds.

N_DRAWS = 4000
SEED = 0

LIB_REPS = ["Lib1", "Lib2", "Lib3"]
DBD_REPS = ["TF1", "TF2", "TF3"]
ALL_SAMPLES = ["Lib_input"] + LIB_REPS + ["DBD_input"] + DBD_REPS


def _delta_from_counts(count_matrix, n_motifs):
    """count_matrix: dict sample -> np.array of per-motif counts.
    Returns (delta, lib_reps_by_motif, dbd_reps_by_motif) using the same
    pseudocount-corrected frequency definition as compute_log2fc."""
    freq = {}
    for s, c in count_matrix.items():
        freq[s] = (c + PSEUDO) / (c.sum() + n_motifs * PSEUDO)
    lib = np.log2(np.array([freq[r] for r in LIB_REPS]) / freq["Lib_input"])
    dbd = np.log2(np.array([freq[r] for r in DBD_REPS]) / freq["DBD_input"])
    return dbd.mean(axis=0) - lib.mean(axis=0), lib, dbd


def resample_delta(all_counts, observed_tiers, n_motifs=64,
                   n_draws=N_DRAWS, seed=SEED):
    """Poisson resampling of read counts. observed_tiers maps motif index to
    the tier string returned by classify_tier on the observed data."""
    rng = np.random.default_rng(seed)
    obs = {s: np.array([all_counts[s].get(i, 0) for i in range(n_motifs)],
                       dtype=float) for s in ALL_SAMPLES}

    deltas = np.empty((n_draws, n_motifs))
    retained = np.zeros(n_motifs)

    for d in range(n_draws):
        drawn = {s: rng.poisson(v).astype(float) for s, v in obs.items()}
        delta, lib, dbd = _delta_from_counts(drawn, n_motifs)
        deltas[d] = delta
        separated = dbd.min(axis=0) > lib.max(axis=0)
        for i in range(n_motifs):
            tier = observed_tiers.get(i)
            if tier == "T1":
                ok = separated[i] and delta[i] >= T1_DELTA
            elif tier == "T2":
                ok = separated[i] and T2_DELTA <= delta[i] < T1_DELTA
            else:
                continue
            retained[i] += ok
    ...
    return {i: {"ci_low": float(lo[i]), "ci_high": float(hi[i]),
                "tier_retained": float(retained[i] / n_draws)}
            for i in range(n_motifs)}
...
def main():
    ...
    print("\nStage 2b: uncertainty on delta-log2FC...")
    tiers = {i: enrich[i]["tier"] for i in enrich}
    ci = resample_delta(all_counts, tiers, n_motifs=64)
    for i, e in enrich.items():
        e.update(ci[i])
    ...
    # --- Manual annotation corrections (June 2026; extended July 2026) ---
    # Four motifs need manual curation because Odom 2004 listed their loci under
    # legacy gene identifiers that no longer match current symbols/RefSeq accessions:
    #
    # motif_37 (FCAMR, NM_001170631): Odom listed it as FKSG87 (NM_032029),
    # a legacy placeholder for the same gene (NCBI Gene ID 83953). S2 hepatocyte.
    #
    # motif_47 (ZNF44, NM_016264): BLAT returned two equal-score alignments;
    # manual inspection confirmed proximity to ZNF44 (GIOT-2 in Odom), in S2 and S3.
    #
    # motif_13 (KIF12, NM_138424): Odom listed it as LOC113220 (NM_138424),
    # the provisional name for NCBI Gene ID 113220 = KIF12. S3 islet. The motif
    # maps 155 bp from the KIF12 promoter (chr9:114099447, hg38).
    #
    # motif_50 (PTRHD1, NM_024322): the motif sits at the bidirectional PTRHD1/CENPO
    # promoter (chr2:24793002, hg38, sequence-verified). Odom captured the locus as
    # CENPO under its legacy name MGC11266 (NM_024322). S2 hepatocyte.
    MANUAL_CORRECTIONS = {
        37: {"gene": "FCAMR",  "refseq": "NM_001170631", "tissue": "liver",
             "evidence": "S2_manual_FKSG87_alias"},
        47: {"gene": "ZNF44",  "refseq": "NM_016264",    "tissue": "both",
             "evidence": "S2_S3_manual_GIOT2_alias"},
        13: {"gene": "KIF12",  "refseq": "NM_138424",    "tissue": "islet",
             "evidence": "S3_manual_LOC113220_alias"},
        50: {"gene": "PTRHD1", "refseq": "NM_024322",    "tissue": "liver",
             "evidence": "S2_manual_CENPO_MGC11266_alias"},
    }
    ...
    with open(OUTPUT_DIR / "HNF1A_B1H_VERIFIED_ordered_with_hits.tsv","w", newline="") as f:
        ...
        for rank, m in enumerate(motifs, 1):
            w.writerow([rank, m["motif_id"], m["gene"] or "", m["refseq"] or "",
                        ...
                        f"{m['delta']:.3f}",
                        f"{enrich[m['motif_num']]['ci_low']:.3f}",
                        f"{enrich[m['motif_num']]['ci_high']:.3f}",
                        f"{enrich[m['motif_num']]['tier_retained']:.3f}"])
    ...
    print(f"\n{n_odom}/{len(motifs)-1} library variants match Odom 2004 ({100*n_odom/(len(motifs)-1):.1f}%)")
    ...
    # Table D3: read-count uncertainty for the hits
    print("\nTable D3: enrichment uncertainty for the hits "
          f"({N_DRAWS:,} Poisson draws, seed {SEED})")
    print(f"  {'motif':<10s} {'gene':<14s} {'delta':>7s}  {'95% CI':>18s}  {'retained':>9s}")
    for m in sorted([m for m in motifs if m["tier"] in ("T1","T2")], key=lambda x: -x["delta"]):
        e = enrich[m["motif_num"]]
        ci_txt = f"{e['ci_low']:+.2f} to {e['ci_high']:+.2f}"
        print(f"  {m['motif_id']:<10s} {(m['gene'] or '?'):<14s} {m['delta']:+7.2f}  "
              f"{ci_txt:>18s}  {100*e['tier_retained']:8.1f}%")
