...
a fixed effect-size cut on the replicate-mean Delta log2FC (Methods 2.13), not a
...
def main():
    ...
    MANUAL_CORRECTIONS = {
        ...
        13: {"gene": "KIF12",  "refseq": "NM_138424",    "tissue": "islet",
             "odom_evidence": "S3_manual_LOC113220_alias"},
        50: {"gene": "PTRHD1", "refseq": "NM_024322",    "tissue": "liver",
             "odom_evidence": "S2_manual_CENPO_MGC11266_alias"},
    }
