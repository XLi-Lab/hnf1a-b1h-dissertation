...
| --- | --- | --- |
| `hnf1a_b1h_pipeline.py` | Phase 1 bacterial one-hybrid: demultiplexing, counting, log2FC, tissue annotation, tier assignment, enrichment uncertainty | 3.2 to 3.6, Tables 1, D1 and D3 |
| `analyse_consensus_distance.py` | Tier 1 consensus by majority vote and Hamming distance by functional class | 3.8, Figure 5 |
| `analyse_af3_confidence.py` | AlphaFold 3 model confidence for the 21 modelled sites | 3.10, Figure 6, Table D2 |
| `analyse_dms.py` | Deep mutational scan: site variants, coding variants, per-residue fitness, protein by DNA doubles | 3.13 to 3.17, Figures 8 to 12 |
